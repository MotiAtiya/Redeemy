...
export default function AddOccasionScreen() {
  ...
  async function handleSave() {
    ...
    const data: Omit<Occasion, 'id' | 'createdAt' | 'updatedAt'> = {
      ...
      type: occasionType,
      name: name.trim(),
      customLabel: occasionType === 'other' ? customLabel.trim() : undefined,
      eventDate,
      afterSunset,
      useHebrewDate,
      hebrewDateStr: hebrewDateDisplay ?? undefined,
      hebrewDay: hebrewDate ? hebrewDate.getDate() : undefined,
      hebrewMonth: hebrewDate ? hebrewDate.getMonth() : undefined,
